...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center max-w-[1280px] py-[100px] px-[10px] w-full">
      <div className="Header">
        <h1 className="text-4xl font-bold">Blind app tinybid: Secure Single-Item First-Price Auction Demo</h1>
        <div className="description text-xl font-medium">
